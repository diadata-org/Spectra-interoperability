...
async function main() {
  ...
  if(network.chainId === 11155420n){
    diaRecipient = "0x5f3Ae50D513fA347fB39571fF81DFa56AAf385D6";
  } else {
    diaRecipient = "0x97C989740aE765518FA85E64ED61512D39765e43";
  }

  formattedRecipient = addressToBytes32(
    diaRecipient
  );
  ...
  switch (network.chainId){
    ...
    case 11155420n: {
      mailBoxAddress = "0x6966b0E55883d49BFB24539356a2f8A673E02039"
     oracleRequestorAddress = "0xbb3673d4c8c0B6681E59BAD091d506567812f790"
   } 
    break;
  }
